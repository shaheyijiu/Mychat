...
public abstract class HXSDKHelper {
    ...
    public synchronized boolean onInit(Context context){
        ...
        System.out.println("AppProcessName="+hxModel.getAppProcessName());
    ...
    /**
     * the subclass must override this class to provide its own model or directly use {}
     * @return
     */
    ...
    public boolean isLogined(){
        return hxModel.getHXId() != null && hxModel.getPwd() != null;
    }
